...
const styles = StyleSheet.create({
  ...
  question: { fontSize: 28, fontFamily: FONT, fontWeight: '300', lineHeight: 36, letterSpacing: -0.3 },
  hint: { fontSize: 12, fontFamily: FONT, fontWeight: '300', lineHeight: 18 },
  ...
  count: { fontFamily: FONT, fontSize: 11, letterSpacing: 1, textAlign: 'center', fontWeight: '300' },
